...
$(function () {
	...
	modules.preferences = {
		...
		run: function (params, token, callback) {
			...
			if (params.change != "undefined") change = '&change='+params.change;
			if (params.key != "undefined" && params.value != "undefined") keyValue = '&optionname='+params.key+'&optionvalue='+params.value;
