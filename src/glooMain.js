			...
			for (var i = 0; i < l; i++) {
				...
				for (var j = 0; j < l2; j++) {
					if (data[i].title === this.recentChanges[j].info.pageTitle || data[i].title === iglooF('actions').currentPage) {
						...
						if (!p) igloo.log('PAGE NOT FOUND- ', data[i].title, this.recentChanges, this.recentChanges[i], i);
...
igloo.extendProto(iglooSettings, function () {
	return {
		...
		buildInterface: function () {
			...
			this.popup = new iglooPopup('<div id="igloo-settings-header" style+"padding-left:10px;"><h3 style="font-weight:bold;">Settings</h3></div><div id="igloo-settings-tabs" style="width: 790px; height: 14px; padding-left: 10px; "></div><div id="igloo-settings-content" style="width: 800px; height: 385px; border-top: 1px solid #000;"></div>');
